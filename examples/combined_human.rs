...
fn main() {
    ...
    println!(
        "File size:     {} ({})",
        file_size.format_human(DECIMAL),
        file_size.format_human(BINARY)
    );
    println!(
        "Transfer time: {} ({})",
        transfer_time.format_human(),
        transfer_time.format_human_precise()
    );
    println!(
        "Transfer rate: {} ({})",
        transfer_rate.format_human(DECIMAL),
        transfer_rate.format_human(BINARY)
    );
    ...
    println!(
        "\nBackup size: {} ({})",
        backup_size.format_human(DECIMAL),
        backup_size.format_human(BINARY)
    );
    println!(
        "Backup rate: {} ({})",
        backup_rate.format_human(DECIMAL),
        backup_rate.format_human(BINARY)
    );
    ...
    println!(
        "\nStream rate: {}  duration: {}  total: {}",
        stream_rate.format_human(DECIMAL),
        stream_duration.format_human(),
        total_streamed.format_human(DECIMAL)
    );
}
